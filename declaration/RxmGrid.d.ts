 ...
 * 表格数据对象
 */
declare type TRxmGridReloadDataArgs = {
    /**
     * 数据请求类型，默认为URl
     */
    type: string;
 ...
 * 表格reload参数对象
 */
declare type TRxmGridReloadArgs = {
    /**
     * 表格数据
     * ```
        //数据类型为对象类型
 ...
 * 事件参数对象
 */
declare type TRxmGridEventArgs = {
    /**
     * 事件绑定的回叫函数
     */
 ...
 * 表格加载数据完成参数对象
 */
declare type TRxmGridLoadCompleteArgs = {
    /**
     * 传入的参数值
     */
    data?: Object;

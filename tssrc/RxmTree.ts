...
class RxmTree{
     ...
     * 获取树的全部节点数据
     */
    getNodes():Array<TRxmTreeNodeObj>{return []}
     ...
     * @param args 绑定命令参数
     */
    bindReloadOk(args:any/*TRxmcCmdBind*/):void{}
     ...
     */
    expandAll(expandFlag:boolean):boolean{return true}
     ...
     * @returns 用户数据
     */ 
    toPlainNodes(args:Array<TRxmTreeNodeObj>):Array<Object>{return []}

    /**
     * 去除选中节点中的ztree节点特殊属性，返回用户数据
     * @returns 用户数据
     */
    getPlainSelectedNodes():Object{return {}}

    /**
     * 去除'checked'节点中的ztree节点特殊属性，返回用户数据
     * @returns 用户数据
     */
    getPlainCheckedNodes():Object{return {}}
    //rxmLoadFormat():void{}

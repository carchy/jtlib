...
type  TFormReloadArgs={
   /**form初始化数据 */
   form?:TPageFormArgs,
   ajaxOkFormat?:(params:{[key:string]:any})=>void
   formInitOk?:(params:{[key:string]:any})=>void
   /**数据加载成功  作为 ajax sucess */
   reloadSuccess?:  (params:{[key:string]:any})=>void 
...
class RxmPage {
    ...
    */
   loading(config: TPageLoadingArgs): Object { return {} }

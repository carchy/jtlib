 ...
 * 
 */
type TRxmRouterMgrLoadHomeRoutersArgs={
/**
    * 可选,标题,默认为空
    */
   title?: string,
...
type TRxmRouterMgrLoadHomeRouters={
  router:TPageRouterArgs,
  args:TRxmRouterMgrLoadHomeRoutersArgs
  
}
type  TRxmRouterMgrLoadHome={
  local?:{
...
class RxmRouterMgr {
   ...
   * @return  {Object}
   */
  getSonsByGroup(pageIdOrPageRouter: string, callback: (routers: { [key: string]: Array<TPageRouterArgs> }) => void): void { }
  /**
   * 根据id 路由名称获取所有的子路由
  ...
  //hideLoading(bhide: boolean): void
  // reset(arrAuth: Array<TPageRouterArgs>): void
}
